...
export const DISTRICT_PREFIX: Record<Lang, string> = {
  ro: "livrare-beton",
  ru: "dostavka-betona",
...
const SEO: Record<Lang, { title: string; description: string; ogLocale: string }> = {
  ...
  en: {
    title: "Concrete delivery Chișinău — instant price on the map | DARSAN",
    description:
...
export function localBusinessSchema(): Record<string, unknown> {
  const schema: Record<string, unknown> = {
    ...
    description:
      "Livrare beton, nisip și pietriș în Chișinău și suburbii. Alegem automat cea mai apropiată stație, la cel mai mic preț pe transport.",
    priceRange: "$$",
